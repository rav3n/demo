...
public class RxErrorHandlingCallAdapterFactory extends CallAdapter.Factory {
    ...
    public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        return new RxCallAdapterWrapper(context, retrofit, original.get(returnType, annotations, retrofit));
    }
    ...
    private static class RxCallAdapterWrapper implements CallAdapter<Object, Observable<?>> {
        ...
        public RxCallAdapterWrapper(Context context, Retrofit retrofit, CallAdapter<?, ?> wrapped) {
        ...
        private RetrofitException asRetrofitException(Throwable throwable) {
            ...
            if (throwable instanceof IOException) {
                return RetrofitException.networkError(new IOException("alksdj"));
            }
